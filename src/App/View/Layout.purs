...
import CSS (CSS, fromString, (?), fontSize, display, inlineBlock, marginTop, marginRight, marginLeft, px, value, key, color, backgroundColor, padding, borderRadius, margin)
...
css = do
  ...
  fromString ".test" ? do
    ...
    display inlineBlock
    borderRadius (2.0 #px) (2.0 #px) (2.0 #px) (2.0 #px)
    margin (0.2 #px) (1.0 #px) (0.2 #px) (1.0 #px)
    padding (0.2 #px) (1.0 #px) (0.2 #px) (1.0 #px)
    textDecoration noneTextDecoration
